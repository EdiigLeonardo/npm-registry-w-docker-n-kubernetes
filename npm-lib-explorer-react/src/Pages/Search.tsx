...
export default class App extends React.Component<IAppProps, IAppState> {
  ...
  componentDidUpdate(prevProps: any, prevState: any) {
    if (JSON.stringify(prevState) !== JSON.stringify(this.state)) {
      ...
      //http://localhost:3000/packageInfo/search/${text}
      this.serviceInstance.addNpmRegistry({url: `http://localhost:3000/packageInfo/search/${this.changeInputValue}`, res: JSON.stringify(this.state)})
    }
  }
